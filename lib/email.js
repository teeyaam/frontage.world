...
export function passwordResetEmail(user, token) {
  ...
  return {
    ...
    html: shell(
      "Reset your password",
      `<p>We got a request to reset the password on your Frontage account. This link is valid for 1 hour and can only be used once:</p>
       ${button(link, "Choose a new password")}
       <p style="font-size:13px;color:#8B9199">If the button doesn't work, open this link:<br/>${link}</p>
       <p style="font-size:13px;color:#8B9199">If you didn't request this, you can safely ignore this email — your password won't change.</p>`
    ),
  };
}
